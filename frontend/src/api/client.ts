 ...
 *
 * O backend responde em RFC 7807 com um `code` proprio -- INVALID_TARGET,
 * SCAN_QUEUE_FULL, NMAP_PRIVILEGE -- e um `detail` escrito para ser lido por
 ...
 *
 * Nao pode falhar: um erro a tratar um erro deixava o utilizador sem nada. Se o
 ...
 *
 * Um 409 quer dizer que o scan acabou entretanto -- quem sonda de 1500 em 1500 ms
