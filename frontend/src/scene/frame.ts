 ...
 *
 * O R3F passa o `delta` do relogio em bruto -- `state.clock.getDelta()`,
 * sem limite nenhum. Com o separador em segundo plano o `requestAnimationFrame`
 ...
 *
 * Isso rebenta com qualquer `lerp(a, b, k * delta)`. Com k=10, o alfa ia a
 ...
 *
 * 50 ms e um frame a 20 fps. Abaixo disso nada muda; acima, a animacao continua de
